...
MASS_STD = 0.25
MASS_RANGE = np.array([0.2, 0.2])
GAIN_RANGE = np.array([1.0, 1.0])

EXP_DIR = BASE_DIR + '/../experiments/crl_box_rnn_8mass/'
BATCH_SIZE = 10
N_EPOCHS = 350
...
BODY_OFFSET =  [np.array([0., 0., 0.]), np.array([0.02, 0., 0.]),
                np.array([0., 0.02, 0.]), np.array([0., 0., 0.015]),
                np.array([0.02, 0., 0.015]), np.array([0.02, 0.02, 0.]),
                np.array([0., 0.02, 0.015]), np.array([0.02, 0.02, 0.015])]
...
#BODY_IDX = np.array([find_objects_in_model(MODEL_PATH).keys()[0],])
...
agent = {
    ...
    'pos_body_idx': np.array(body_idx), 
    'pos_body_offset': BODY_OFFSET, 
