...
EXP_DIR = BASE_DIR + '/../experiments/mjc_tf_multimass/'
...
agent = {
    ...
    'x0': np.concatenate([np.array([-1.0, 1.0, 1.54, -1.7, 1.54, -0.2, 0]),
                          np.zeros(7)]),
    'dt': 0.05,
    'substeps': 5,
    'conditions': common['conditions'],
    'mass_body_idx': np.array([12]),
    'mass_body_mult': [np.array([0.25]), np.array([0.25]), np.array([0.25]),
                       np.array([0.25])],
