...
#from gps.algorithm.policy_opt.tf_model_example import example_rnn_network
...
EXP_DIR = BASE_DIR + '/../experiments/mjc_rnn_multimass/'
...
agent = {
    'type': AgentMuJoCo,
    'filename': './mjc_models/pr2_arm3d_gravity.xml',
    'x0': np.concatenate([np.array([-0.4, 0.25, -3.0, -1.7, 1.54, -0.2, 0]),
                          np.zeros(7)]),
    'dt': 0.05,
    'substeps': 5,
    'conditions': common['conditions'],
    'mass_body_idx': np.array([12]),
    'mass_body_mult': [np.array([0.25]), np.array([0.5]), np.array([0.75]),
                       np.array([1.00])],
    'body_color_offset': [np.array([0.1, 0.1, 0.1, 0.0]),
                          np.array([0.2, 0.2, 0.2, 0.0]),
                          np.array([0.3, 0.3, 0.3, 0.0]),
                          np.array([0.4, 0.4, 0.4, 0.0]),
                          ],
    ...
    'camera_pos': np.array([5., 0., 0., 0., 0.0, 0.2]),
}
