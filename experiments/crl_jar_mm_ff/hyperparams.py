...
EXP_DIR = BASE_DIR + '/../experiments/crl_jar_mm_ff/'
MODEL_FILE = './mjc_models/PR2/pr2_jar.xml' 
...
ee_tgts = [ee_tgt]*common['conditions']
#print 'ee tgt is'
#print ee_tgt
...
agent = {
    ...
    'mass_body_mult': [np.random.uniform(low=MASS_RANGE[0], 
                        high=MASS_RANGE[1], size=num_obj) 
