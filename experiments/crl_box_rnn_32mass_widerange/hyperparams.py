...
MASS_STD = 0.25
MASS_RANGE = np.array([0.05, 0.6])
GAIN_RANGE = np.array([1.0, 1.0])

EXP_DIR = BASE_DIR + '/../experiments/crl_box_rnn_32mass_widerange/'
BATCH_SIZE = 10
N_EPOCHS = 350
...
BODY_OFFSET += [np.random.normal(0., scale=0.04, size=3) for _ in range(CONDITIONS-1)]
###############
# DONT CHANGE #
###############
