...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_i2b.pack(_x.id, _x.mode, _x.arm))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.pd_gains))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.mode, _x.arm,) = _struct_i2b.unpack(str[start:end])
      start = end
      end += 4
      ...
      self.pd_gains = struct.unpack(pattern, str[start:end])
      return self
