...
class TrialCommand(genpy.Message):
  _md5sum = "202c0096b43b748d774bec96f2bd24ec"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_ib.pack(_x.id, _x.controller.controller_to_execute))
      ...
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.controller.caffe.bias))
      length = len(self.controller.caffe.scale)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.controller.caffe.scale))
      _x = self
      buff.write(_struct_i2I.pack(_x.controller.caffe.dim_bias, _x.controller.lingauss.dX, _x.controller.lingauss.dU))
      length = len(self.controller.lingauss.K_t)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.controller.lingauss.K_t))
      length = len(self.controller.lingauss.k_t)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.controller.lingauss.k_t))
      _x = self
      buff.write(_struct_Iid.pack(_x.controller.tf.dU, _x.T, _x.frequency))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.ee_points))
      length = len(self.ee_points_tgt)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.ee_points_tgt))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.controller.controller_to_execute,) = _struct_ib.unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.controller.caffe.net_param = str[start:end].decode('utf-8')
      else:
      ...
      self.controller.caffe.bias = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.controller.caffe.scale = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      (_x.controller.caffe.dim_bias, _x.controller.lingauss.dX, _x.controller.lingauss.dU,) = _struct_i2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.controller.lingauss.K_t = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      (_x.controller.tf.dU, _x.T, _x.frequency,) = _struct_Iid.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sb'%length
      ...
      self.ee_points = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ee_points_tgt = struct.unpack(pattern, str[start:end])
      return self
