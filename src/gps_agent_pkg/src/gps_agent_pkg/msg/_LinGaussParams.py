...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2I.pack(_x.dX, _x.dU))
      length = len(self.K_t)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.K_t))
      length = len(self.k_t)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.k_t))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.dX, _x.dU,) = _struct_2I.unpack(str[start:end])
      start = end
      end += 4
      ...
      self.K_t = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
