...
class DataType(genpy.Message):
  _md5sum = "c3c44feec69c131249e197b7b6372aff"
  _type = "gps_agent_pkg/DataType"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """int8 data_type  # Enum
...
"""
  ...
  _slot_types = ['int8','std_msgs/Float64MultiArray']
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_b.pack(self.data_type))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.data_type,) = _struct_b.unpack(str[start:end])
      start = end
      end += 4
