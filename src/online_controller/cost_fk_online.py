...
class CostFKOnline(object):
    def __init__(self, eetgt, jnt_tgt=None, jnt_wp=None, ee_idx=None, jnt_idx=None, use_jacobian=True, maxT=None):
        ...
        self.l2 = 1.0
        self.alpha = 1e-5
        self.wu = 5.0e-3/np.array([3.09,1.08,0.393,0.674,0.111,0.152,0.098])  # Brett CostFK Big least squares
        self.wu = 1.0e-2/np.array([3.09,1.08,0.393,0.674,0.111,0.152,0.098])  # MJC CostFK
