...
BOOST_PYTHON_MODULE(mjcpy2) {
    ...
    bp::class_<PyMJCWorld2,boost::noncopyable>("MJCWorld2","docstring here", bp::init<const std::string&>())

        .def("Step",&PyMJCWorld2::Step)
        .def("StepMulti",&PyMJCWorld2::StepMulti)
        ...
        .def("GetModel",&PyMJCWorld2::GetModel)
        .def("GetOption",&PyMJCWorld2::GetOption)
        .def("SetOption", &PyMJCWorld2::SetOption)
        .def("GetData",&PyMJCWorld2::GetData)
        .def("Plot",&PyMJCWorld2::Plot)
        .def("Idle",&PyMJCWorld2::Idle)
        .def("GetFeatDesc",&PyMJCWorld2::GetFeatDesc)
        .def("GetCOMMulti",&PyMJCWorld2::GetCOMMulti)
        .def("GetJacSite",&PyMJCWorld2::GetJacSite)
        .def("GetContacts",&PyMJCWorld2::GetContacts)
        .def("SetFeats",&PyMJCWorld2::SetFeats)
        // .def("SetModel",&PyMJCWorld::SetModel)
        // .def("GetImage",&PyMJCWorld::GetImage)
        .def("SetNumSteps",&PyMJCWorld2::SetNumSteps)
        ;
