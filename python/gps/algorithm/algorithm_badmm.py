...
TRAJINFO_VARS = ['dynamics', 'x0mu', 'x0sigma', 'cc', 'cv', 'Cm',
                 ...
                 'lambda_k', 'lambda_K', 'pol_wt', 'pol_mu', 'pol_sig',
...
class AlgorithmBADMM(Algorithm):
    ...
    def iteration(self, sample_lists):
        ...
        for inner_itr in range(self._hyperparams['inner_iterations']):
            if self.iteration_count > 0 or inner_itr > 0: #TODO: could start from init controller
    ...
    def _update_policy(self):
        ...
        self.policy.update(samples.get_obs(), tgt_mu, tgt_prc, tgt_wt)
    ...
    def _update_policy_fit(self, m, init=False):
        ...
        pol_mu, pol_sig = self.policy.prob(samples.get_obs())
    ...
    def _policy_dual_step(self, m, step=False):
        ...
        traj_ev, traj_em = estimate_moments(X, traj_mu, traj.pol_covar)  #TODO: write estimate_moments
        ...
        kl = self._policy_kl()  #TODO: implement policy_kl
