...
class DataLogger:
	...
	def pickle(data, data_type, itr, data_dir=self._data_files_dir):
		"""
		...
		"""
		filename = data_dir + data_type + '_itr_' + str(itr) + '.p'
		pickle.dump(data, open(filename, 'wb'))

	def unpickle(data_type, itr, data_dir=self._data_files_dir):
		"""
		type: string either 'sample' or 'algorithm'
		itr: integer represent iteteration number
		data_dir: the directory in which to look for the data 
